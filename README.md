# Sigmacoin - a cryptocurrency implementation in less than 1500 lines of code
...
```sh
# Run a node
$ node bin/sigmacoin.js

# Run two nodes
$ node bin/sigmacoin.js -p 3001 --name 1
$ node bin/sigmacoin.js -p 3002 --name 2 --peers http://localhost:3001
...
```sh
# Build the image
$ docker build . -t sigmacoin

# Run sigmacoin in a docker
$ ./dockerExec.sh

# Run sigmacoin in a docker using port 3002
$ ./dockerExec.sh -p 3002

# Run sigmacoin in a docker options
$ ./dockerExec.sh -h
...
$ node bin/sigmacoin.js -h
Usage: bin\sigmacoin.js [options]
...
```sh
# Cloning repository
$ git clone git@github.com:conradoqg/sigmacoin.git
$ cd sigmacoin
$ npm install
